...
exports.run = async (client, message, params, args) => {
  ...
  if (!hgkanali) return message.channel.send(':no_entry: Hoşgeldin kanalı ayarlamak için bir kanal etiketlemeniz gerekli. `!hoşgeldinkanal #kanal`')
